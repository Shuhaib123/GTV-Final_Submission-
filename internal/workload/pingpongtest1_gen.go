//go:build workload_pingpongtest1
// +build workload_pingpongtest1
...
func Runpingpongtest1Program( // main Goroutine emulates pong-part
__jspt_ctx_8 context.Context) {
	...
	gtvtrace.InstallStopAfterFromEnv(
		"GTV_TIMEOUT_MS")
	__jspt_ctx_8, __jspt_task_9 := trace.NewTask(__jspt_ctx_8, "pingpongtest1")
	defer __jspt_task_9.End()
	trace.Log(__jspt_ctx_8, "main", "pingpongtest1 starting")
...
func init() {
	RegisterWorkload("pingpongtest1",

		Runpingpongtest1Program)
}

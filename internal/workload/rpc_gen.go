...
func RunrpcProgram(__jspt_ctx_5 context.Context) {
	var __jspt_wg_0 sync.WaitGroup
	defer __jspt_wg_0.Wait()
	__jspt_ctx_5, __jspt_task_6 := trace.NewTask(__jspt_ctx_5, "rpc")
	defer __jspt_task_6.End()
	trace.Log(__jspt_ctx_5, "main", "rpc starting")
	...
	go func(__jspt_ctx_13 context.Context,) {
		trace.WithRegion(__jspt_ctx_13, "goroutine: anon",

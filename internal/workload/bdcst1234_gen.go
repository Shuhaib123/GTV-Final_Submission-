//go:build workload_bdcst1234
// +build workload_bdcst1234
...
func Runbdcst1234Program(__jspt_ctx_8 context.Context) {
	...
	__jspt_ctx_8, __jspt_task_9 := trace.NewTask(__jspt_ctx_8, "bdcst1234")
	defer __jspt_task_9.End()
	trace.Log(__jspt_ctx_8, "main", "bdcst1234 starting")

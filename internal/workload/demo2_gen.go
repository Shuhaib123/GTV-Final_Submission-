//go:build workload_demo2
// +build workload_demo2
...
func Rundemo2Program(__jspt_ctx_8 context.Context) {
	...
	__jspt_ctx_8, __jspt_task_9 := trace.NewTask(__jspt_ctx_8, "demo2")
	defer __jspt_task_9.End()
	trace.Log(__jspt_ctx_8, "main", "demo2 starting")
...
func init() {
	RegisterWorkload("demo2", Rundemo2Program,
	)
}

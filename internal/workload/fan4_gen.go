...
func Runfan4Program(__jspt_ctx_8 context.Context) {
	...
	__jspt_ctx_8, __jspt_task_9 := trace.NewTask(__jspt_ctx_8, "fan4")
	defer __jspt_task_9.End()
	trace.Log(__jspt_ctx_8, "main", "fan4 starting")

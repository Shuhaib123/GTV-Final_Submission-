//go:build workload_idealo123
// +build workload_idealo123
...
func Runidealo123Program(__jspt_ctx_8 context.Context) {
	...
	__jspt_ctx_8, __jspt_task_9 := trace.NewTask(__jspt_ctx_8, "idealo123")
	defer __jspt_task_9.End()
	trace.Log(__jspt_ctx_8, "main", "idealo123 starting")

//go:build workload_idealo1
// +build workload_idealo1
...
func Runidealo1Program(__jspt_ctx_8 context.Context) {
	...
	__jspt_ctx_8, __jspt_task_9 := trace.NewTask(__jspt_ctx_8, "idealo1")
	defer __jspt_task_9.End()
	trace.Log(__jspt_ctx_8, "main", "idealo1 starting")
...
func init() {
	RegisterWorkload("idealo1", Runidealo1Program,
	)
}

//go:build workload_btest
// +build workload_btest
...
func RunbtestProgram(__jspt_ctx_8 context.Context) {
	...
	__jspt_ctx_8, __jspt_task_9 := trace.NewTask(__jspt_ctx_8, "btest")
	defer __jspt_task_9.End()
	trace.Log(__jspt_ctx_8, "main", "btest starting")

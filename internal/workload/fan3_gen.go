...
func Runfan3Program(__jspt_ctx_8 context.Context) {
	...
	__jspt_ctx_8, __jspt_task_9 := trace.NewTask(__jspt_ctx_8, "fan3")
	defer __jspt_task_9.End()
	trace.Log(__jspt_ctx_8, "main", "fan3 starting")
	...
	go func(__jspt_ctx_21 context.Context,) {
		trace.WithRegion(__jspt_ctx_21, "goroutine: anon",
	...
	go func(__jspt_ctx_22 context.Context,) {
		trace.WithRegion(__jspt_ctx_22, "goroutine: anon", func() {
			{
				defer __jspt_wg_0.Done()
				trace.Log(__jspt_ctx_8,

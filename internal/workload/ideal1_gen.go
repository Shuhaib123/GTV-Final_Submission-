//go:build workload_ideal1
// +build workload_ideal1
...
func Runideal1Program(__jspt_ctx_8 context.Context) {
	...
	__jspt_ctx_8, __jspt_task_9 := trace.NewTask(__jspt_ctx_8, "ideal1")
	defer __jspt_task_9.End()
	trace.Log(__jspt_ctx_8, "main", "ideal1 starting")
...
func init() {
	RegisterWorkload("ideal1", Runideal1Program,
	)
}

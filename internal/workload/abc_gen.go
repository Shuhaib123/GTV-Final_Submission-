...
func RunabcProgram(__jspt_ctx_8 context.Context) {
	...
	__jspt_ctx_8, __jspt_task_9 := trace.NewTask(__jspt_ctx_8, "abc")
	defer __jspt_task_9.End()
	trace.Log(__jspt_ctx_8, "main", "abc starting")
...
func init() {
	RegisterWorkload("abc", RunabcProgram,
	)
}

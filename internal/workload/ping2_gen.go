//go:build workload_ping2
// +build workload_ping2
...
func Runping2Program( // main Goroutine emulates pong-part
	...
	gtvtrace.InstallStopAfterFromEnv(
		"GTV_TIMEOUT_MS")
	__jspt_ctx_8, __jspt_task_9 := trace.NewTask(__jspt_ctx_8, "ping2")
	defer __jspt_task_9.End()
	trace.Log(__jspt_ctx_8, "main", "ping2 starting")
